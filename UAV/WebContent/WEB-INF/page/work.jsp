  ...
  <div class="col-md-4">
      ...
      <div class="layui-card">
        ...
        <div class="layui-card-body" style="height: 200px;background-repeat: round;">
         ...
         <a href="action?url=WEB-INF/page/addwork.jsp" targe="_blank"> <button class="layui-btn layui-btn-radius layui-btn-lg" style="width: 85%;margin-left: 25px "><i class="layui-icon" style="font-size: 30px;">&#xe642;</i>&nbsp&nbsp点击发布作品</button></a>
