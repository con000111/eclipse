...
public class SendMail {
	...
	public SendMail(String SMTPHost, String Port, String MailUsername, String MailPassword) {
		...
		// 设置系统属性
		Security.addProvider(new com.sun.net.ssl.internal.ssl.Provider());//徐sir SSL
		final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";//徐sir SSL
		props = java.lang.System.getProperties(); // 获得系统属性对象
		props.put("mail.smtp.host", SMTPHost); // 设置SMTP主机
		props.put("mail.smtp.port", Port); // 设置服务端口号
		props.put("mail.smtp.socketFactory.class", SSL_FACTORY);//徐sir SSL
		props.setProperty("mail.smtp.socketFactory.fallback", "false");//徐sir SSL
		props.setProperty("mail.smtp.socketFactory.port", "465");//徐sir SSL
